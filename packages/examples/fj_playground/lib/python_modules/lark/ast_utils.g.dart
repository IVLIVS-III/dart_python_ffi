...
final class AsList extends PythonClass {
  factory AsList() => PythonFfi.instance.importClass(
        "lark.ast_utils",
        "AsList",
        AsList.from,
        <Object?>[],
...
final class Ast extends PythonClass {
  factory Ast() => PythonFfi.instance.importClass(
        "lark.ast_utils",
        "Ast",
        Ast.from,
        <Object?>[],
...
final class WithMeta extends PythonClass {
  factory WithMeta() => PythonFfi.instance.importClass(
        "lark.ast_utils",
        "WithMeta",
        WithMeta.from,
        <Object?>[],
...
final class ast_utils extends PythonModule {
  ...
  static ast_utils import() => PythonFfi.instance.importModule(
        "lark.ast_utils",
        ast_utils.from,
      );
