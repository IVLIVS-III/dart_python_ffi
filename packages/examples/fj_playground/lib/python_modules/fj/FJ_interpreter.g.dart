...
final class FJ_interpreter extends PythonModule {
  ...
  ///     write_in_type(out_file_path, type_of_expression)
  /// ```
  Object? only_typecheck({
    required String file_path,
    String out_file_path = "",
  }) =>
      getFunction("only_typecheck").call(
        <Object?>[
          file_path,
          out_file_path,
        ],
  ...
  /// ## only_typecheck_on_file_to_terminal
  ///
  /// ### python source
  /// ```py
  /// def only_typecheck_on_file_to_terminal(file_path: str):
  ...
  ///     print(f"\nType is -> {type_of_expression}\n")
  /// ```
  Object? only_typecheck_on_file_to_terminal({
    required String file_path,
  }) =>
      getFunction("only_typecheck_on_file_to_terminal").call(
        <Object?>[
          file_path,
        ],
        kwargs: <String, Object?>{},
  ...
  ///     print("\tIf the given outpath doesn't exist, a new file is created\n")
  /// ```
  Object? print_help() => getFunction("print_help").call(
        <Object?>[],
        kwargs: <String, Object?>{},
      );
  ...
  ///     write_in_computed(out_file_path, type_of_expression, computed_expression)
  /// ```
  Object? run_interpreter_on_file({
    required String file_path,
    String out_file_path = "",
  }) =>
      getFunction("run_interpreter_on_file").call(
        <Object?>[
          file_path,
          out_file_path,
        ],
  ...
  /// ## run_interpreter_on_file_to_terminal
  ///
  /// ### python source
  /// ```py
  /// def run_interpreter_on_file_to_terminal(file_path: str):
  ...
  ///     print(f"\n{computed_expression} :: {type_of_expression}\n")
  /// ```
  Object? run_interpreter_on_file_to_terminal({
    required String file_path,
  }) =>
      getFunction("run_interpreter_on_file_to_terminal").call(
        <Object?>[
          file_path,
        ],
        kwargs: <String, Object?>{},
  ...
  ///         file.write(f"{computed_expression} :: {type_of_expression}\n")
  /// ```
  Object? write_in_computed({
    required String file_path,
    required Type type_of_expression,
    required NewClass computed_expression,
  }) =>
      getFunction("write_in_computed").call(
        <Object?>[
          file_path,
          type_of_expression,
          computed_expression,
  ...
  ///         file.write(f"Type is -> {type_of_expression}\n")
  /// ```
  Object? write_in_type({
    required String file_path,
    required Type type_of_expression,
  }) =>
      getFunction("write_in_type").call(
        <Object?>[
          file_path,
          type_of_expression,
        ],
